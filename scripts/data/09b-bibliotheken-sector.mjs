/** Sectorpagina BIBLIOTHEKEN (de beroepsgroep staat in 09-sport-bibliotheken.mjs). */

export const sector = {
  naam: 'Bibliotheken',
  slug: 'bibliotheken',
  samenvatting:
    'Bureau Weerbaar en Veilig traint bibliotheekmedewerkers in het begrenzen van grensoverschrijdend gedrag in een ruimte die bewust voor iedereen open is. Voor medewerkers met een balie- en publieksfunctie, in drie niveaus.',
  afbeeldingAlt: 'Bezoekers in de publieksruimte van een bibliotheek',
  intro: [
